...
const crudResolversMap = {
  ...
  Anime: crudResolvers.AnimeCrudResolver
};
const actionResolversMap = {
  ...
  Anime: {
    findUniqueAnime: actionResolvers.FindUniqueAnimeResolver,
    findFirstAnime: actionResolvers.FindFirstAnimeResolver,
    findManyAnime: actionResolvers.FindManyAnimeResolver,
    createAnime: actionResolvers.CreateAnimeResolver,
    deleteAnime: actionResolvers.DeleteAnimeResolver,
    updateAnime: actionResolvers.UpdateAnimeResolver,
    deleteManyAnime: actionResolvers.DeleteManyAnimeResolver,
    updateManyAnime: actionResolvers.UpdateManyAnimeResolver,
    upsertAnime: actionResolvers.UpsertAnimeResolver,
    aggregateAnime: actionResolvers.AggregateAnimeResolver
  }
};
